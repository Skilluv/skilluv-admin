export interface Translations {
	...
	admin: {
		...
		dataLine: {
			...
			deliverBtn: string;
			delivered: string;
			openLicenceTitle: string;
			licenseeOrgLabel: string;
			licenseeTypeLabel: string;
			contractPurposeLabel: string;
			startsOnLabel: string;
			endsOnLabel: string;
			totalFeeLabel: string;
			shareLabel: string;
			shareHint: string;
			openLicenceBtn: string;
			licenceOpened: string;
			settleTitle: string;
			settleHint: string;
		...
		oversight: {
			...
			stats: {
				...
				active: string;
				activeHint: string;
				challengesPublished: string;
				challengesDraft: string;
				contestsRunning: string;
				contestsConcluded: string;
				missionsInProgress: string;
				missionsDelivered: string;
				reviewsPending: string;
				oldestReview: string;
				oldestReviewHint: string;
				nothingWaiting: string;
				meanRounds: string;
				meanRoundsHint: string;
				lastFeatured: string;
			};
			hours: string;
		...
		contracts: {
			...
			noActions: string;
			noSource: string;
			openSubmissionsBtn: string;
			orientationLabel: string;
			recordRetentionBtn: string;
			registerHint: string;
			searchHint: string;
			searchLabel: string;
			serviced: string;
		...
		review: {
			...
			notesLabel: string;
			verdictBtn: string;
			verdictRecorded: string;
			emptyBugs: string;
			severityLabel: string;
			adjustSeverityLabel: string;
			adjustSeverityHint: string;
			...
			translationBtn: string;
			translationDone: string;
			reviewsListTitle: string;
			noReviews: string;
			proficiencyUnknown: string;
		...
		programs: {
			...
			urlLabel: string;
			addLivestreamBtn: string;
			livestreamAdded: string;
			livestreamHint: string;
			...
			addFindingBtn: string;
			removeFindingBtn: string;
			notesLabel: string;
			auditBtn: string;
			audited: string;
			revokeBtn: string;
			...
			emptySponsored: string;
			eventIdHint: string;
			eventIdLabel: string;
			feeHint: string;
			feeLabel: string;
			loadSponsoredBtn: string;
			openPiece: string;
			publishBtn: string;
			publishUrlHint: string;
			publishUrlLabel: string;
			published: string;
			publishedOn: string;
			sponsorIdLabel: string;
		...
		financeLine: {
			...
			stats: {
				awaitingDisbursal: string;
				undecided: string;
				unpaid: string;
				drafts: string;
			};
			emptyAdvances: string;
			emptyReferrals: string;
			emptyClaims: string;
			emptyPartnerships: string;
			disburseBtn: string;
			disbursed: string;
			repaidBtn: string;
			repaid: string;
			...
			regulatoryBasisHint: string;
			registryUrlLabel: string;
			openPartnershipBtn: string;
			partnershipOpened: string;
		...
		operations: {
			...
			subtitle: string;
			opsLabel: string;
			assistantBilled: string;
			assistantBilledHint: string;
			assistantCacheRate: string;
			assistantHint: string;
			assistantPolicy: string;
			assistantRefusedBurst: string;
			assistantRefusedHint: string;
			assistantRefusedQuota: string;
			assistantRequests: string;
			assistantSection: string;
			assistantTokens: string;
			assistantUsers: string;
			assistantWorkerFailures: string;
			assistantWorkerHint: string;
			badgeRecomputeHint: string;
			badgeRecomputeTitle: string;
			badgesRecomputed: string;
			certsExpired: string;
			...
			commissionHint: string;
			commissionTitle: string;
			contentRunsSection: string;
			curatedFlagLabel: string;
			curatedHint: string;
			curatedSet: string;
			curatedTitle: string;
			days30: string;
			...
			days7: string;
			days90: string;
			deleteFlagBtn: string;
			deleteFlagWarning: string;
			disableBtn: string;
			enableBtn: string;
			expireCertsHint: string;
			expireCertsTitle: string;
			flagDeleted: string;
			flagDescriptionLabel: string;
			flagKeyLabel: string;
			flagSaved: string;
			flagsHint: string;
			flagsSection: string;
			leversSection: string;
			menteeIdLabel: string;
			mentorIdLabel: string;
			mirrorDone: string;
			mirrorHint: string;
			mirrorTitle: string;
			newFlagHint: string;
			...
			noFlags: string;
			projectSlugLabel: string;
			readmeSyncDone: string;
			readmeSyncHint: string;
			readmeSyncTitle: string;
			rolloutLabel: string;
		...
		engagement: {
			...
			talentOffers: {
				...
				reinstated: string;
				hidden: {
					paused_by_author: string;
					moderation_hold: string;
					author_hidden: string;
					author_banned: string;
					rank_below_bar: string;
				};
				types: {
